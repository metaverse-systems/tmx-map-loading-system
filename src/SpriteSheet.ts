class SpriteSheet
{
   ...
   */
  draw = (spriteX, spriteY, x, y, options: { flipVertical: boolean; flipHorizontal: boolean; flipDiagonal: boolean; scale: number; } 
           = { flipVertical: false, flipHorizontal: false, flipDiagonal: false, scale: 1 }) => {
